...
export async function runPlannerAgent(formData) {
  ...
  const climatePrompt = `
You are an expert agricultural climate analyst specializing in Kerala, India.
...
`
  ...
  // Agent 3 — Care Guides
  const carePrompt = `
You are a Kerala agricultural extension officer providing practical farming guidance.
